...
export const modelProfiles: ModelProfile[] = [
  {
    ...
    providerModelId: "poolside-laguna-m-1",
    speed: "balanced",
  ...
  },
  {
    ...
    provider: "openrouter",
    capabilities: ["chat", "code", "reasoning", "planning", "debug"],
    priority: 92,
  ...
  },
  {
    ...
    provider: "nvidia",
    capabilities: ["chat", "code", "planning", "tool_use", "reasoning"],
    priority: 98,
    contextWindow: 128_000,
    supportsStreaming: true,
    supportsToolCalling: true,
    preferredIntents: ["agent", "tool_use", "planning", "kilocode"],
    endpoint: "https://integrate.api.nvidia.com/v1/chat/completions",
    providerModelId: "deepseek-ai/deepseek-v4-flash-0731",
    speed: "fast",
    costEstimate: "medium",
    latency: "low",
    specialization: ["tool_use", "coding", "planning"],
    defaultScore: 97
  },
  {
    id: "nvidia-qwen3.5-122b",
    name: "NVIDIA Qwen 3.5 122B",
    displayName: "Qwen 3.5 122B (NVIDIA NIM)",
    provider: "nvidia",
    capabilities: ["chat", "code", "planning", "tool_use", "reasoning"],
    priority: 96,
    contextWindow: 128_000,
  ...
  },
  {
    ...
    supportsStreaming: true,
    supportsToolCalling: true,
    preferredIntents: ["fast", "autocomplete"],
    endpoint: "https://integrate.api.nvidia.com/v1/chat/completions",
    providerModelId: "nvidia/nemotron-3-nano-30b-a3b",
    speed: "ultra_fast",
    costEstimate: "low",
    latency: "low",
    specialization: ["coding", "autocomplete"],
    defaultScore: 88
  },
  {
  ...
  },
  {
    ...
    capabilities: ["chat", "code", "patching", "planning", "reasoning", "debug"],
    priority: 48,
    contextWindow: 32_000,
    supportsStreaming: true,
    supportsToolCalling: false,
  ...
  },
  {
    ...
    provider: "open_source",
    capabilities: ["chat", "code", "reasoning", "patching", "planning", "debug"],
    priority: 50,
    contextWindow: 128_000,
    supportsStreaming: true,
    supportsToolCalling: false,
